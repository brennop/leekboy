...
Instruction instructions[256] = {
    ...
    {"RET NZ", 1, 20},      {"POP BC", 1, 12},       {"JP NZ, a16", 3, 16},
    {"JP a16", 3, 16},      {"CALL NZ, a16", 3, 24}, {"PUSH BC", 1, 16},
    {"ADD A, d8", 2, 8},    {"RST 00H", 1, 16},      {"RET Z", 1, 20},
    {"RET ", 1, 16},        {"JP Z, a16", 3, 16},    {"PREFIX ", 1, 4},
    {"CALL Z, a16", 3, 24}, {"CALL a16", 3, 24},     {"ADC A, d8", 2, 8},
    {"RST 08H", 1, 16},     {"RET NC", 1, 20},       {"POP DE", 1, 12},
    {"JP NC, a16", 3, 16},  {"ILLEGAL_D3 ", 1, 4},   {"CALL NC, a16", 3, 24},
    {"PUSH DE", 1, 16},     {"SUB d8", 2, 8},        {"RST 10H", 1, 16},
    {"RET C", 1, 20},       {"RETI ", 1, 16},        {"JP C, a16", 3, 16},
    {"ILLEGAL_DB ", 1, 4},  {"CALL C, a16", 3, 24},  {"ILLEGAL_DD ", 1, 4},
